...
public class ModifeirProduitController implements Initializable {
 ...
 ServiceProduit sr = new ServiceProduit(cnx);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        imageeget = FXMain.pr.getImg();
              NomProduit.setText(FXMain.pr.getNomproduit());
      PrixProduit.setText(FXMain.pr.getPrix()+"");
      QuantProduit.setText(FXMain.pr.getQuantityproduit()+"");
      imageText.setText(FXMain.pr.getImg());
    ...
    private void Enregistremagasin(ActionEvent event) throws IOException {
       ...
       if (NomProduit.getText().equals("")){
        ...
        System.out.println(ColorProdut.getValue().toString());
                       Produit r = new Produit(FXMain.pr.getId(),NomProduit.getText(),Double.parseDouble(PrixProduit.getText()),Integer.parseInt(QuantProduit.getText()),1, imageeget,"#"+ColorProdut.getValue().toString().subSequence(2, 8));
                       sr.modifier(r);
